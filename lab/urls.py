...
urlpatterns = [
    ...
    url(r'^turnos/calendar/TICS/$', login_required(views.TICSCalendarView.as_view()), name='TICS-calendar'),
    url(r'^turnos/calendar/TICS/(?P<year>[0-9]{4})/(?P<month>[0-9]{2})/$', login_required(views.TICSCalendarView.as_view()), name='TICS-calendar'),
    ...
    url(r'^turnos/TICS/$', login_required(views.TICSList.as_view()), name='TICS-list'),
    ...
    url(r'^turnos/EXT/create/$', cache_control(max_age=0, no_cache=True, no_store=True)(login_required(views.EXTCreate.as_view())),
                                 name='EXT-create'),
    url(r'^turnos/TICS/create/$', cache_control(max_age=0, no_cache=True, no_store=True)(login_required(views.TICSCreate.as_view())),
                                 name='TICS-create'),
    ...
    url(r'^turnos/EXT/update/(?P<pk>\d+)/$', cache_control(max_age=0, no_cache=True, no_store=True)(login_required(views.EXTUpdate.as_view())),
                                             name='EXT-update'),
    url(r'^turnos/TICS/update/(?P<pk>\d+)/$', cache_control(max_age=0, no_cache=True, no_store=True)(login_required(views.TICSUpdate.as_view())),
        name='TICS-update'),
    ...
    url(r'^turnos/LIA/update/(?P<pk>\d+)/revision/', views.createRevision, name='LIA-revision'),
    url(r'^turnos/LIM1/update/(?P<pk>\d+)/revision/', views.createRevision, name='LIM1-revision'),
    url(r'^turnos/LIM2/update/(?P<pk>\d+)/revision/', views.createRevision, name='LIM2-revision'),
    url(r'^turnos/LIM3/update/(?P<pk>\d+)/revision/', views.createRevision, name='LIM3-revision'),
    url(r'^turnos/LIM4/update/(?P<pk>\d+)/revision/', views.createRevision, name='LIM4-revision'),
    url(r'^turnos/LIM5/update/(?P<pk>\d+)/revision/', views.createRevision, name='LIM5-revision'),
    url(r'^turnos/LIM6/update/(?P<pk>\d+)/revision/', views.createRevision, name='LIM6-revision'),
    url(r'^turnos/EXT/update/(?P<pk>\d+)/revision/', views.createRevision, name='EXT-revision'),
    url(r'^turnos/TICS/update/(?P<pk>\d+)/revision/', views.createRevision, name='TICS-revision'),
    url(r'^turnos/DES/update/(?P<pk>\d+)/revision/', views.createRevision, name='DES-revision'),
    url(r'^turnos/CAL/update/(?P<pk>\d+)/revision/', views.createRevision, name='CAL-revision'),
    url(r'^turnos/MEC/update/(?P<pk>\d+)/revision/', views.createRevision, name='MEC-revision'),
    url(r'^turnos/ML/update/(?P<pk>\d+)/revision/', views.createRevision, name='ML-revision'),
    url(r'^turnos/LIA/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='LIA-rollback'),
    url(r'^turnos/LIM1/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='LIM1-rollback'),
    url(r'^turnos/LIM2/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='LIM2-rollback'),
    url(r'^turnos/LIM3/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='LIM3-rollback'),
    url(r'^turnos/LIM4/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='LIM4-rollback'),
    url(r'^turnos/LIM5/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='LIM5-rollback'),
    url(r'^turnos/LIM6/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='LIM6-rollback'),
    url(r'^turnos/EXT/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='EXT-rollback'),
    url(r'^turnos/TICS/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='TICS-rollback'),
    url(r'^turnos/DES/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='DES-rollback'),
