...
urlpatterns = [
    ...
    url(r'^turnos/LIA/update/(?P<pk>\d+)/rollback/', 'lab.views.rollBackRevision', name='LIA-revision'),
    url(r'^turnos/LIM1/update/(?P<pk>\d+)/rollback/', 'lab.views.rollBackRevision', name='LIM1-revision'),
    url(r'^turnos/LIM2/update/(?P<pk>\d+)/rollback/', 'lab.views.rollBackRevision', name='LIM2-revision'),
    url(r'^turnos/LIM3/update/(?P<pk>\d+)/rollback/', 'lab.views.rollBackRevision', name='LIM3-revision'),
    url(r'^turnos/LIM6/update/(?P<pk>\d+)/rollback/', 'lab.views.rollBackRevision', name='LIM6-revision'),
    url(r'^turnos/EXT/update/(?P<pk>\d+)/rollback/', 'lab.views.rollBackRevision', name='EXT-revision'),
    url(r'^turnos/SIS/update/(?P<pk>\d+)/rollback/', 'lab.views.rollBackRevision', name='SIS-revision'),
    url(r'^turnos/DES/update/(?P<pk>\d+)/rollback/', 'lab.views.rollBackRevision', name='DES-revision'),
