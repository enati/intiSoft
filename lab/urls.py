...
urlpatterns = [
    ...
    url(r'^turnos/SIS/update/(?P<pk>\d+)/revision/', views.createRevision, name='SIS-revision'),
    ...
    url(r'^turnos/SIS/update/(?P<pk>\d+)/rollback/', views.rollBackRevision, name='SIS-rollback'),
