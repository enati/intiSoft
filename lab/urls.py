...
urlpatterns = [
    ...
    url(r'^turnos/CAL/create/$', login_required(views.CALCreate.as_view()), name='CAL-create'),
    url(r'^turnos/MEC/create/$', login_required(views.MECCreate.as_view()), name='MEC-create'),
    url(r'^turnos/ML/create/$', login_required(views.MLCreate.as_view()), name='ML-create'),
    ...
    url(r'^turnos/CAL/update/(?P<pk>\d+)/$', login_required(views.CALUpdate.as_view()), name='CAL-update'),
    url(r'^turnos/MEC/update/(?P<pk>\d+)/$', login_required(views.MECUpdate.as_view()), name='MEC-update'),
    url(r'^turnos/ML/update/(?P<pk>\d+)/$', login_required(views.MLUpdate.as_view()), name='ML-update'),
