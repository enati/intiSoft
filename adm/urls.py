...
urlpatterns = [
    ...
    url(r'^contratos/SOT/viewSOT/(?P<pk>\d+)/$', cache_control(max_age=0, no_cache=True, no_store=True)(login_required(views.viewSOT)), name='sot-viewSOT'),
    ...
    url(r'^contratos/RUT/viewRUT/(?P<pk>\d+)/$', cache_control(max_age=0, no_cache=True, no_store=True)(login_required(views.viewRUT)), name='rut-viewRUT'),
    ...
    url(r'^contratos/SI/viewSI/(?P<pk>\d+)/$', cache_control(max_age=0, no_cache=True, no_store=True)(login_required(views.viewSI)), name='si-viewSI'),
