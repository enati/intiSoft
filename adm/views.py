...
from .models import Presupuesto, OfertaTec, Usuario, OT, OTML, SI, Factura
from lab.models import OfertaTec_Linea
from .forms import PresupuestoForm, OfertaTecForm, UsuarioForm, OTForm, OTMLForm, SIForm, Factura_LineaFormSet,\
                   OT_LineaFormSet, Remito_LineaFormSet, Tarea_LineaFormSet
